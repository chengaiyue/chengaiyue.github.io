...
//			}
	...
	function tool() {
		...
		this.cloudDisk = document.getElementById('cloudDisk');
	}
	...
	tool.prototype.cloud = function () {
		var _this = this;
		this.cloudDisk.addEventListener('dblclick',function () {
			window.location.href = 'weiyun.html';
		});
	};
